          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="text-center space-y-6">
                {/* Desktop: Nome centralizado + título/CRP centralizados abaixo */}
                <div className="hidden lg:block lg:text-center lg:mb-6">
                  <motion.h2 
                    className="font-light text-3xl lg:text-4xl xl:text-5xl text-slate-800 tracking-tight leading-tight mb-4"
                  ...
                  {/* Título profissional e CRP centralizados */}
                  <div className="text-center">
                    <p className="text-gray-700 font-medium text-lg xl:text-xl mb-1">
                      {(() => {
                ...
                {/* Mobile: Layout alinhado à esquerda */}
                <div className="lg:hidden mb-6 text-left">
                  <motion.h2 
                    className="font-light text-2xl sm:text-3xl text-slate-800 mb-4 leading-tight"
                    initial={{ opacity: 0, y: 20 }}
                    animate={isVisible ? { opacity: 1, y: 0 } : {}}
                    transition={{ duration: 0.7, delay: 0.2 }}
                  >
                  ...
                  {/* Container com traço e informações profissionais */}
                  <div className="flex items-start gap-4">
                    {/* Traço vertical */}
                    <div className="w-px h-12 bg-gradient-to-b from-rose-300 to-purple-300 flex-shrink-0 mt-1"></div>

                    {/* Título profissional e CRP */}
                    <div>
